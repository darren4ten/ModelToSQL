//------------------------------------------------------------------------------
// <copyright file="CMDGenerateSQLPackage.cs" company="Microsoft">
...
namespace VSIXModelToSQL
{
    ...
    /// </para>
    /// </remarks>
    [ProvideAutoLoad("D309F791-903F-11D0-9EFC-00A0C911004F")]
    ...
    {
        /// <summary>
        /// CMDGenerateSQLPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "3ee0abe6-3bbb-47c5-82c8-7341b67cfe7f";

        /// <summary>
        /// Initializes a new instance of the <see cref="CMDGenerateSQL"/> class.
        /// </summary>
        public CMDGenerateSQLPackage()
        {
